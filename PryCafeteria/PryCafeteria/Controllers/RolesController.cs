...
namespace PryCafeteria.Controllers
{
    public class RolesController : Controller
    {
        ...
        public RolesController(BdcafeteriaContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Create([Bind("RolId,RolNombre")] Role role)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("RolId,RolNombre")] Role role)
        {
            if (id != role.RolId)
            {
                return NotFound();
